                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="overview-wrap">
                            <h2 class="title-1">add vehicle</h2>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('vehicle.store')}}" method="POST" enctype="multipart/form-data">   {{-- </form> thunder fire you --}} 
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" name="millage" id="milage" class="form-control @error('millage') is-invalid @enderror">
                                            @error('milage')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="engine_number" id="engine" class="form-control @error('engine_number') is-invalid @enderror">
                                            @error('engine')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" name="video_url" id="video_url" class="form-control @error('video_url') is-invalid @enderror">
                                            @error('video_url')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" name="horse_type" id="horse_type" class="form-control @error('horse_type') is-invalid @enderror">
                                            @error('horse_type')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="number_of_gear" id="gear" class="form-control @error('number_of_gear') is-invalid @enderror">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="door" id="door" class="form-control @error('door') is-invalid @enderror">
                                            @error('door')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input class="form-control form-control @error('price') is-invalid @enderror" type="text" name="price" id="price">
                                            @error('price')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="file">Upload Featured Vehicle </label>
                                            <input type="file"  name="featured_image" id="file" class="form-control">
